...
<section class="portfolio-w3ls " id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">PROPERTIES</h3>
         @foreach ($display_properties['data'] as $AllProperty)
				<div class="col-md-3 gallery-grid gallery1">

                    {{-- <?php $img=json_decode($AllProperty->images) ?>
					<a href={{ asset('/uploads/'.$img[0])}} class="swipebox"><img src="{{ asset('/uploads/'.$img[0])}}" class="img-responsive" alt="/">
                        {{-- <img src="{{ asset('/uploads/'.$img[0])}}"class="swipebox" alt="..." style="height: 140px; width: auto;"> --}}
						{{-- <div class="textbox"> --}}
						{{-- <h4>{{strtoupper($AllProperty->propertyname)}}</h4> --}}
...
<section class="contact-w3ls m-3" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<iframe src="https://mapcarta.com/12746886"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
